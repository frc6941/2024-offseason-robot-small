...
public class shooter extends SubsystemBase {
    ...
    public void setShooterVelocity(double RPM_L, double RPM_H) {
        // SmartDashboard.putNumber("Shooter/SHOOTER-L
        // ACT",shooterMotorL.getVelocity().getValue());
        // SmartDashboard.putNumber("Shooter/SHOOTER-L REQ",
        // Units.rotationsPerMinuteToRadiansPerSecond(RPM_L));
        ...
        shooterMotorH.setControl(new VelocityVoltage(
                ...
                false,
                false));
        System.out.println(shooterMotorH.getVelocity().getValue());
    }
    ...
    public void setShooterVelocity(double RPM) {
        ...
        // SmartDashboard.putNumber("Shooter/SHOOTER-H
        // ACT",shooterMotorH.getVelocity().getValue());
        // SmartDashboard.putNumber("Shooter/SHOOTER-H REQ",
        // Units.rotationsPerMinuteToRadiansPerSecond(RPM));
        shooterMotorH.setControl(new VelocityVoltage(
                Units.radiansToRotations(Units.rotationsPerMinuteToRadiansPerSecond(-RPM)),
                0.0,
