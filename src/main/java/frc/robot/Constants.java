...
public class Constants {
    ...
    public class SwerveDrivetrian {
        ...
        public static final double deadband = maxSpeed.magnitude() * 0.12;
        public static final double rotationalDeadband = maxAngularRate.magnitude() * 0.12;
        ...
        public static class driveGainsClass {
            public static final TunableNumber DRIVE_KP = new TunableNumber("DRIVE PID/kp", 0.02);
            public static final TunableNumber DRIVE_KI = new TunableNumber("DRIVE PID/ki", 0.007);
            public static final TunableNumber DRIVE_KD = new TunableNumber("DRIVE PID/kd", 0.005);
